    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl text-center space-y-6">
          ...
          <p className="text-[18px] lg:text-[20px] leading-[32px] font-[Montserrat] text-justify mt-16">
          ...
          <button className="mt-4 border-2 border-[#CE9D4B] text-[#CE9D4B] rounded-full px-6 py-2 text-[16px] font-medium hover:bg-[#CE9D4B] hover:text-black transition duration-300 mt-16">
            View Entire Journey
          </button>
        </div>
      </div>
